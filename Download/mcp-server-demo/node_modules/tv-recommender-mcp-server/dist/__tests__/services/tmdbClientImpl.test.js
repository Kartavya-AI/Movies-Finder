...
describe('TMDbClient Implementation Tests', () => {
    ...
    beforeEach(() => {
        // 重置验证API密钥的模拟函数
        config_1.validateApiKey.mockClear();
        // 创建一个模拟的axios实例
        axiosInstance = {
            get: jest.fn(),
            post: jest.fn(),
        ...
        axiosCreateSpy = jest.spyOn(axios_1.default, 'create').mockReturnValue(axiosInstance);
        // 创建新的TMDbClient实例
    ...
    describe('Lazy Loading Client', () => {
        it('初始化时不应该创建axios实例', () => {
            ...
            expect(config_1.validateApiKey).not.toHaveBeenCalled();
        });
        it('第一次调用方法时应该创建axios实例', async () => {
            ...
            // 验证validateApiKey被调用
            expect(config_1.validateApiKey).toHaveBeenCalledTimes(1);
        });

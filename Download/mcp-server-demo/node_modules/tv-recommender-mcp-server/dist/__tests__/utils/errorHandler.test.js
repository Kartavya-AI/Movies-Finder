...
describe('Error Handler Utils', () => {
    ...
    describe('ApiError', () => {
        it('应该正确构造带有默认状态码的ApiError', () => {
            const error = new errorHandler_1.ApiError('测试错误');
        ...
        it('应该正确构造带有自定义状态码的ApiError', () => {
            const error = new errorHandler_1.ApiError('请求错误', 400);
    ...
    describe('formatErrorMessage', () => {
        it('应该正确格式化ApiError', () => {
            const error = new errorHandler_1.ApiError('请求错误', 400);
            const formattedMessage = (0, errorHandler_1.formatErrorMessage)(error);
        ...
        it('应该处理非Error类型的错误', () => {
            const formattedMessage1 = (0, errorHandler_1.formatErrorMessage)('字符串错误');
            expect(formattedMessage1).toBe('发生未知错误');
            const formattedMessage2 = (0, errorHandler_1.formatErrorMessage)(null);
            expect(formattedMessage2).toBe('发生未知错误');
            const formattedMessage3 = (0, errorHandler_1.formatErrorMessage)(undefined);
    ...
    describe('registerGlobalErrorHandlers', () => {
        ...
        it('应该正确处理未捕获的异常', () => {
            ...
            const [[, uncaughtExceptionHandler]] = processOnMock.mock.calls.filter(call => call[0] === 'uncaughtException');
            // 模拟调用处理程序
        ...
        it('应该正确处理未处理的Promise拒绝', () => {
            ...
            const [[, unhandledRejectionHandler]] = processOnMock.mock.calls.filter(call => call[0] === 'unhandledRejection');

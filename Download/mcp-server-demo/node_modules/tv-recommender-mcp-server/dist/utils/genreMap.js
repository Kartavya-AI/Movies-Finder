...
exports.mapGenreToId = mapGenreToId;
exports.getGenreNameById = getGenreNameById;
// TMDb 支持的主要电视剧类型
...
function mapGenreToId(genreName) {
    ...
    // 2. 再检查主要类型列表
    // 先精确匹配
    const exactMatch = exports.genreList.find(genre => genre.englishName.toLowerCase() === normalizedName ||
        genre.chineseName === normalizedName);
    if (exactMatch)
        return exactMatch.id;
    // 3. 最后进行模糊匹配（包含关系）
    const fuzzyMatch = exports.genreList.find(genre => genre.englishName.toLowerCase().includes(normalizedName) ||
...
function getGenreNameById(genreId) {
    const genre = exports.genreList.find(g => g.id === genreId);

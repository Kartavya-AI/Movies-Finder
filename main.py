...
async def main():
    ...
    if "llm" not in st.session_state:
        st.session_state.llm = ChatOpenAI(model="gpt-3.5-turbo",base_url="https://openrouter.ai/api/v1",api_key="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",max_tokens=200,temperature=0.7)
